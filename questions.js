...
const QUESTIONS = [
  ...
  //  stars & bars, itertools, lab exercises
  // ═══════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════
  //  TOPIC 2: RECURSION
  //  Covers: base/recursive cases, factorial,
  //  fibonacci, sum, harmonic, digits, GCD,
  //  Pascal, even sum, sum of factorials
  // ═══════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════
  //  TOPIC 3: GRAPHS
  //  Covers: types, NetworkX, degree, adjacency,
  //  paths, cycles, self-loops, representations
  // ═══════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════
  //  TOPIC 4: TREES, MST, BFS & DFS
  //  Covers: tree properties, terminology,
  //  NetworkX tree ops, full binary tree,
  //  spanning tree, MST, BFS, DFS
  // ═══════════════════════════════════════════

  // --- Tree Properties (TRICKY) ---
  {
    id: "tr-01",
    topic: "trees",
    difficulty: "easy",
  ...
  // --- Exam Reminders (Tricky Summaries) ---
  {
    id: "tr-44",
    topic: "trees",
    difficulty: "hard",
